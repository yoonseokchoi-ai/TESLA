...
class ContentEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        - down-sampling layer outputs (for multi-level adversarial learning)
        - final ResBlocks output (for Decoder input)
        """
...
##################################################################################
# MONAI conv helpers (UnetBasicBlock, UnetOutBlock, etc.)
##################################################################################
...
##################################################################################
# PatchNCE network (define_F, PatchSampleF, etc.)
##################################################################################
